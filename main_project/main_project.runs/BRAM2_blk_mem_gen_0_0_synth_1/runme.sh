...
HD_PWD='/home/batman/Desktop/216_assignments/main_project/main_project.runs/BRAM2_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM2_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM2_blk_mem_gen_0_0.tcl
